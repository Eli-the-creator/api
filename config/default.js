...
module.exports = {
  ...
  platforms: {
    linkedin: {
      ...
      password: process.env.LINKEDIN_PASSWORD,
      cookiesPath:
        process.env.LINKEDIN_COOKIES_PATH || "./cookies/linkedin.json",
      useCookies: process.env.LINKEDIN_USE_COOKIES === "true",
      selectors: {
        loginButton: ".nav__button-secondary",
        emailField: "#username",
        passwordField: "#password",
    ...
    indeed: {
      username: process.env.INDEED_USERNAME,
      password: process.env.INDEED_PASSWORD,
      cookiesPath: process.env.INDEED_COOKIES_PATH || "./cookies/indeed.json",
      useCookies: process.env.INDEED_USE_COOKIES === "true",
      selectors: {
        // Селекторы для Indeed будут определены в модуле платформы
      },
      urls: {
    ...
    glassdoor: {
      ...
      password: process.env.GLASSDOOR_PASSWORD,
      cookiesPath:
        process.env.GLASSDOOR_COOKIES_PATH || "./cookies/glassdoor.json",
      useCookies: process.env.GLASSDOOR_USE_COOKIES === "true",
      selectors: {
        // Селекторы для Glassdoor будут определены в модуле платформы
      },
      urls: {
